...
#print("Unique Status Codes in Destination File:", status_codes.unique())
...
for src_url in urls_source_list:
    ...
    # Se il best match ha status code diverso da 200, aggiungilo alla lista delle destinazioni no 200
